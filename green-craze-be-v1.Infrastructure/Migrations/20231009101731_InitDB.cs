        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserFollowProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserFollowProducts_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaypalOrderId = table.Column<string>(type: "varchar(255)", nullable: false),
                    PaypalOrderStatus = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFollowProducts_ProductId",
                table: "UserFollowProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_UserFollowProducts_UserId",
                table: "UserFollowProducts",
                column: "UserId");
